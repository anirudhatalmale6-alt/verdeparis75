...
@section('title', 'Ajouter une comparaison Avant/Apres')
        ...
        <form method="POST" action="{{ route('admin.before-after.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="before_image" class="form-label">Image Avant <span class="text-danger">*</span></label>
                    <input type="file" name="before_image" id="before_image" class="form-control" accept="image/*" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="after_image" class="form-label">Image Apres <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="category" id="category" class="form-control" value="{{ old('category') }}" placeholder="ex: Jardin, Terrasse">
                </div>
                <div class="col-md-4 mb-3">
