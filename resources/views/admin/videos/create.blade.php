    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.videos.store') }}" enctype="multipart/form-data" id="uploadForm">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="video_type" id="video_type" class="form-select" required>
                        ...
                        <option value="mp4" {{ old('video_type') == 'mp4' ? 'selected' : '' }}>MP4 / MOV / WEBM</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">MP4, MOV (iPhone), WEBM, AVI - Max 500 Mo - Depuis PC, mobile ou tablette</small>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">JPG, PNG, WEBP - Appareil photo sur mobile</small>
